...
#Izberemo ekipo
enum Team { BLUE, YELLOW, GREEN, RED }
var team: Team
...
func set_player_skin(skin_name: SkinColor) -> void:
	team = Team.values()[skin_name]

	print("DEBUG: Player", name, "is on team", get_team_name())
...
func get_team_name() -> String:
	match team:
		...
		Team.YELLOW: return "YELLOW"
		Team.GREEN: return "GREEN"
		Team.RED: return "RED"
		_: return "UNKNOWN"
